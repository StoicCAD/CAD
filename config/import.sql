-- Dumping structure for table ksrp.cadusers
...
CREATE TABLE IF NOT EXISTS `arrests` (
  ...
  CONSTRAINT `arrests_ibfk_1` FOREIGN KEY (`player_id`) REFERENCES `players` (`id`)
...
CREATE TABLE IF NOT EXISTS `civillians` (
  ...
  CONSTRAINT `civillians_ibfk_1` FOREIGN KEY (`player_id`) REFERENCES `players` (`id`),
  CONSTRAINT `civillians_ibfk_2` FOREIGN KEY (`discord_id`) REFERENCES `cadusers` (`discord_id`)
...
CREATE TABLE IF NOT EXISTS `incidents` (
  ...
  CONSTRAINT `incidents_ibfk_1` FOREIGN KEY (`reported_by`) REFERENCES `cadusers` (`id`)
...
CREATE TABLE IF NOT EXISTS `reports` (
  ...
  KEY `player_id` (`player_id`),
  CONSTRAINT `reports_ibfk_1` FOREIGN KEY (`player_id`) REFERENCES `players` (`id`)
...
CREATE TABLE IF NOT EXISTS `tickets` (
  ...
  KEY `player_id` (`player_id`),
  CONSTRAINT `tickets_ibfk_1` FOREIGN KEY (`player_id`) REFERENCES `players` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
