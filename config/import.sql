...
-- Updated schema for arrests table
CREATE TABLE IF NOT EXISTS `arrests` (
  ...
  CONSTRAINT `arrests_ibfk_1` FOREIGN KEY (`citizenid`) REFERENCES `players` (`citizenid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Updated schema for civillians table
CREATE TABLE IF NOT EXISTS `civillians` (
  ...
  CONSTRAINT `civillians_ibfk_1` FOREIGN KEY (`citizenid`) REFERENCES `players` (`citizenid`),
  CONSTRAINT `civillians_ibfk_2` FOREIGN KEY (`discord_id`) REFERENCES `users` (`discord_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Updated schema for incidents table
...
-- Updated schema for reports table
CREATE TABLE IF NOT EXISTS `reports` (
  ...
  KEY `citizenid` (`citizenid`),
  CONSTRAINT `reports_ibfk_1` FOREIGN KEY (`citizenid`) REFERENCES `players` (`citizenid`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Updated schema for tickets table
CREATE TABLE IF NOT EXISTS `tickets` (
  ...
  KEY `citizenid` (`citizenid`),
  CONSTRAINT `tickets_ibfk_1` FOREIGN KEY (`citizenid`) REFERENCES `players` (`citizenid`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;


-- Updated schema for nd_characters table
ALTER TABLE `players`
