...
define('DB_PASSWORD', '1Lollypop1!');        // The MySQL database password (replace with your user's password)
define('DB_NAME', 'nat2.0');     // The name of the database you are connecting to

// Discord OAuth Client Credentials:
// You must register your application with Discord to obtain these credentials
define('CLIENT_ID', '1048343259715477565');           // Your Discord client ID
define('CLIENT_SECRET', 'UYorzxg5YU1-kCsxJPYVolt7wCCdqGMc');      // Your Discord client secret
