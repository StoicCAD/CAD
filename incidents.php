...
// Fetch user details
$stmt = $conn->prepare("SELECT id, username, avatar_url, dept, rank, badge_number, super FROM cadusers WHERE id = ?");
...
// Handle form submission to insert new incident
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $title = $_POST['title'];
    $description = $_POST['description'];
    $reported_by = $_SESSION['user_id']; // Using the logged-in user's ID
    ...
    <div id="mainContent" class="flex-1 flex flex-col ml-64 p-10 content">
        <header class="mb-5">
            ...
            <div class="bg-gray-900 p-6 rounded-lg shadow-md">
                <h2 class="text-xl font-semibold mb-4">Report New Active Call</h2>
            ...
            <div class="bg-gray-900 mt-6 p-6 rounded-lg shadow-md">
                <h2 class="text-xl font-semibold mb-4">Existing Active Calls</h2>
                <ul>
